 ...
 */
        ...
        function getUserTweets(twitterName)
        {
            ...
            $.ajax({
                url: 'http://localhost:8080/SOEN_487_Project/webresources/mashedservice/'+twitterName +'/spotify',
                type: 'GET',
                dataType: "json",
                processData: false,
        ...
        function updateStatus(){
            var postdata = {"authUrl": [""], "status": [""]}
            $.ajax({
                url: 'http://localhost:8080/SOEN_487_Project/webresources/mashedservice/update',
                type: 'PUT',
                dataType: 'json',
                data: postdata
            });
